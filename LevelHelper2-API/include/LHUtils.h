...
-(void)removeWaterNode:(LHWater*)node;
-(void)removeCameraNode:(LHCamera*)node;
-(void)removeGravityAreaNode:(LHGravityArea*)node;
-(void)removeParallaxNode:(LHParallax*)node;
@end
